...
var rules: Array = [
	...
	},
	{
		...
		"conditions": {
			...
			"lower_hits_taken": {"op": ">=", "value": 3}
		},
		"enemy_action_1": "standing_defense",
		"enemy_action_2": "crouch_punch",
		"weight": 0.5,
		"wasUsed": false,
		"inScript": false
	},
	...
	#},
	{
		...
		"conditions": { 
			...
			"distance": { "op": ">=", "value": 83 }, 
			"upper_hits_taken": { "op": ">=", "value": 3 } },
		"enemy_action_1": "standing_defense", 
		"enemy_action_2": "basic_punch", 
		"weight": 0.5, 
		"wasUsed": false, 
		"inScript": false
	},
	{
		"ruleID": 12, 
		"prioritization": 27,
		"conditions": { "player_anim": "basic_kick", 
		"distance": { "op": ">=", "value": 100 }, 
		"upper_hits_taken": { "op": ">=", "value": 3 } },
		"enemy_action_1": "standing_defense", 
		"enemy_action_2": "basic_kick", 
		"weight": 0.5, 
		"wasUsed": false, 
		"inScript": false
	},
	{
		...
		"prioritization": 2,
		"conditions": { 
			"distance": { "op": "<=", "value": 80 }, 
			"lower_hits_taken": { "op": ">=", "value": 3 } 
		},
		"enemy_action_1": "walk_backward", 
		"weight": 0.5, 
		"wasUsed": false, 
		"inScript": false
	},
