...
@export_range(0, 1) var defense_probability: float = 0.8
@export_range(0, 200) var defense_trigger_range: float = 75.0
@export_range(0, 2) var defense_cooldown_time: float = 0.25
@export_range(0, 200) var attack_opportunity_range: float = 75.0
@export_range(0, 1) var proactive_attack_chance: float = 0.5
